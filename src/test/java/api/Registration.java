        ...
        try {
            ...
            if (isJSONValid(response) && responseAPI.status() == 200) {
                ...
                if (responsebody.get("message").getAsString() == "Registration Successful!") {
                    System.out.println(
                            "Registration successful with message: " + responsebody.get("message").getAsString());
                } else {
                    System.out
                            .println("Registration failed with message : " + responsebody.get("message").getAsString());
                }
